...
const CustomerHomePage = () => {
  // Keep the existing Index.tsx content for the customer home page
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link to="/auth?tab=signup&role=seller">
                <Button size="lg" variant="outline" className="border-white text-black bg-white/20 w-full sm:w-auto">
                  Become a Seller
                </Button>
              </Link>
            </div>
